...
<body>
	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$sql = "SELECT * FROM admin WHERE name = '$name' AND passcode = '$passcode'";
		...
		if(!empty($row)){
            ...
            header('Location:profileadmin.php?id='.$row['id']);
		}
	...
	<form action="indexadmin.php" method="POST">
		...
		<table>
			...
			<tr>
				<td><input type="password" name="passcode" id="password" placeholder="Enter Your Password"></td>
			</tr>
			<td>
